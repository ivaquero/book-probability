...
$ S_n^2 = frac(1, n-1) ∑_(j=1)^n (X_j - macron(X_n))^2 $
...
#theorem[
  ...
  $
    ∑ frac((Y_j - macron(Y)), σ_2^2 (m - 1)) \/ frac((X_i - macron(X)), σ_1^2 (n-1)) ∼ F(m - 1, n-1)
  $
]
...
#theorem[
  ...
  $
    ∑ [(macron(X)- macron(Y)) - (μ_1 - μ_2)]⋅sqrt((n + m - 2)\/(1 / n + 1 / m)) / sqrt(∑ (X_i - macron(X)) + ∑ (Y_i - macron(Y))) ∼ t (n + m - 2)
  $
]
