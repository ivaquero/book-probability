...
#definition[
  ...
  $ φ(z) = frac(1, sqrt(2pi)) e^(-z^2 / 2), quad -∞ < z < ∞ $
  记作$Z ∼ 𝒩(0, 1)$，因为我们已知$Z$均值为$0$，标准差为$1$。
]

标准正态分布的 CDF 为其 PDF 积分下的面积，即

$ Φ(z) = ∫_(-∞)^z φ(t) dd(t) = ∫_(-∞)^z frac(1, sqrt(2pi)) e^(-t^2 / 2) dd(t) $
...
$
  ...
  &= ∫_0^(2pi) ∫_0^(∞) e^(-r^2 / 2) r dd(r, θ) \
  &= ∫_0^(2pi)(∫_0^(∞) e^(-u) dd(u)) dd(θ) = 2pi
$

由此，$∫_(-∞)^(∞) e^(-z^2 / 2) dd(z) = sqrt(2pi)$，即$frac(1, sqrt(2pi))$是归一化因子。
